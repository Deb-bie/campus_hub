...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<ResponseHandler<AuthResponseDto>> signUp(@RequestBody SignUpRequestDto signUpRequestDto) throws Exception {
    ...
    @PostMapping("/signin")
    public ResponseEntity<ResponseHandler<AuthResponseDto>> signIn(@RequestBody SignInRequestDto signInRequestDto) throws Exception {
